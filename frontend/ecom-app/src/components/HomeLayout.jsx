...
const HomeLayout = () => {
    return (
        <>
            <div className="navbar bg-base-100 flex items-center bg-gradient-to-br from-black to-gray-800">
                ...
                <div className="flex-none">
                    <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bounded-box w-52">
                            <li>
